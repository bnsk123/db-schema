...
CREATE TABLE dj_approval_states (
...
CREATE TABLE cm_ops_proc_state (
                state_id INTEGER NOT NULL,
                state_name VARCHAR(64) NOT NULL,
...
CREATE TABLE cm_ops_action_state (
                state_id INTEGER NOT NULL,
                state_name VARCHAR(64) NOT NULL,
...
CREATE TABLE cms_ci_event_queue (
...
CREATE TABLE dj_release_rev_label (
...
CREATE TABLE dj_dpmt_approvals (
...
CREATE TABLE dj_deployment_state_hist (
...
CREATE TABLE cm_ci_relation_attr_log (
...
CREATE INDEX cm_ci_rel_attr_log_crid
 ON cm_ci_relation_attr_log
 ( ci_relation_id, ci_rel_attribute_id );

CREATE TABLE cm_ci_relation_log (
                log_id BIGINT NOT NULL,
                log_time TIMESTAMP NOT NULL,
                log_event INTEGER NOT NULL,
                ci_relation_id BIGINT NOT NULL,
...
CREATE INDEX cm_ci_relation_log_crid
 ON cm_ci_relation_log
 ( ci_relation_id );

CREATE TABLE cm_ci_attribute_log (
                log_id BIGINT NOT NULL,
                log_time TIMESTAMP NOT NULL,
                log_event INTEGER NOT NULL,
...
CREATE INDEX cm_ci_attribute_log_ciid
 ON cm_ci_attribute_log
 ( ci_id, ci_attribute_id );

CREATE TABLE cm_ci_log (
                log_id BIGINT NOT NULL,
                log_time TIMESTAMP NOT NULL,
                log_event INTEGER NOT NULL,
                ci_id BIGINT NOT NULL,
...
CREATE TABLE cm_ops_procedures (
...
ALTER TABLE dj_dpmt_approvals ADD CONSTRAINT dj_dpmt_approvals_states_fk
FOREIGN KEY (state_id)
REFERENCES dj_approval_states (state_id)
ON DELETE RESTRICT
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE cm_ops_procedures ADD CONSTRAINT cm_ops_procedures_st_fk
FOREIGN KEY (state_id)
REFERENCES cm_ops_proc_state (state_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE cm_ops_actions ADD CONSTRAINT cm_ops_actions_st_fk
FOREIGN KEY (state_id)
REFERENCES cm_ops_action_state (state_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE cms_event_queue ADD CONSTRAINT cms_event_queue_etid_fk
FOREIGN KEY (event_type_id)
REFERENCES cms_event_type (event_type_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE cms_ci_event_queue ADD CONSTRAINT cms_ci_event_queue_etid_fk
FOREIGN KEY (event_type_id)
REFERENCES cms_event_type (event_type_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
...
ALTER TABLE dj_deployment ADD CONSTRAINT dj_deployment_states_dj_deployment_fk
FOREIGN KEY (state_id)
REFERENCES dj_deployment_states (state_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE cm_ci ADD CONSTRAINT cm_ci_ns_fk
FOREIGN KEY (ns_id)
...
ALTER TABLE dj_rfc_ci ADD CONSTRAINT dj_ci_rfc_ns_fk
FOREIGN KEY (ns_id)
REFERENCES ns_namespaces (ns_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE dj_releases ADD CONSTRAINT cm_namespaces_dj_releases_fk
FOREIGN KEY (ns_id)
REFERENCES ns_namespaces (ns_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE dj_deployment ADD CONSTRAINT cm_namespaces_dj_deployment_fk
FOREIGN KEY (ns_id)
REFERENCES ns_namespaces (ns_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE dj_rfc_relation ADD CONSTRAINT dj_rfc_relation_ns_fk
FOREIGN KEY (ns_id)
REFERENCES ns_namespaces (ns_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE cm_ci_relations ADD CONSTRAINT cm_ci_relations_ns_fk
FOREIGN KEY (ns_id)
REFERENCES ns_namespaces (ns_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE cm_ns_opt ADD CONSTRAINT ns_path_cm_ns_opt_fk
FOREIGN KEY (ns_id)
REFERENCES ns_namespaces (ns_id)
ON DELETE CASCADE
ON UPDATE NO ACTION
...
ALTER TABLE dj_ns_opt ADD CONSTRAINT ns_dj_ns_opt_fk
FOREIGN KEY (ns_id)
REFERENCES ns_namespaces (ns_id)
ON DELETE CASCADE
ON UPDATE NO ACTION
...
ALTER TABLE dj_deployment_rfc ADD CONSTRAINT dj_deployment_rfc_dprfcstid_fk
FOREIGN KEY (state_id)
REFERENCES dj_deployment_rfc_states (state_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE cm_ci ADD CONSTRAINT cm_ci_stid_fk
FOREIGN KEY (ci_state_id)
REFERENCES cm_ci_state (ci_state_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE cm_ci_relations ADD CONSTRAINT cm_ci_relations_stid_fk
FOREIGN KEY (ci_state_id)
REFERENCES cm_ci_state (ci_state_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE dj_rfc_ci ADD CONSTRAINT dj_rfc_ci_ciaid_fk
FOREIGN KEY (action_id)
REFERENCES dj_rfc_ci_actions (action_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE dj_rfc_relation ADD CONSTRAINT dj_relation_rfc_actid_fk
FOREIGN KEY (action_id)
REFERENCES dj_rfc_ci_actions (action_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
...
ALTER TABLE dj_releases ADD CONSTRAINT dj_releases_rsid_fk
FOREIGN KEY (release_state_id)
REFERENCES dj_release_states (release_state_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE dj_rfc_ci ADD CONSTRAINT dj_rfc_rid_fk
FOREIGN KEY (release_id)
REFERENCES dj_releases (release_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE dj_rfc_relation ADD CONSTRAINT dj_relation_rfc_relid_fk
FOREIGN KEY (release_id)
REFERENCES dj_releases (release_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE dj_deployment ADD CONSTRAINT dj_deployment_rid_fk
FOREIGN KEY (release_id)
REFERENCES dj_releases (release_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE dj_deployment_rfc ADD CONSTRAINT dj_deployment_dj_deployment_rfc_fk
FOREIGN KEY (deployment_id)
REFERENCES dj_deployment (deployment_id)
ON DELETE CASCADE
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE dj_deployment_state_hist ADD CONSTRAINT dj_deployment_state_hist_fk
FOREIGN KEY (deployment_id)
REFERENCES dj_deployment (deployment_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE dj_dpmt_approvals ADD CONSTRAINT dj_dpmt_approvals_dpmt_id_fk
FOREIGN KEY (deployment_id)
REFERENCES dj_deployment (deployment_id)
ON DELETE CASCADE
ON UPDATE NO ACTION
...
ALTER TABLE md_relation_attributes ADD CONSTRAINT md_relation_attributes_mdrid_fk
FOREIGN KEY (relation_id)
REFERENCES md_relations (relation_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE md_class_relations ADD CONSTRAINT md_class_relations_mdrid_fk
FOREIGN KEY (relation_id)
REFERENCES md_relations (relation_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
...
ALTER TABLE cm_ci_relations ADD CONSTRAINT df_ci_relations_mdrid_fk
FOREIGN KEY (relation_id)
REFERENCES md_relations (relation_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
...
ALTER TABLE dj_rfc_relation ADD CONSTRAINT dj_relation_rfc_rid_fk
FOREIGN KEY (relation_id)
REFERENCES md_relations (relation_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
...
ALTER TABLE cm_ci_relation_attributes ADD CONSTRAINT cm_ci_relation_attributes_raid_fk
FOREIGN KEY (attribute_id)
REFERENCES md_relation_attributes (attribute_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE dj_rfc_relation_attributes ADD CONSTRAINT md_relation_attributes_dj_rfc_relation_attributes_fk
FOREIGN KEY (attribute_id)
REFERENCES md_relation_attributes (attribute_id)
ON DELETE RESTRICT
ON UPDATE NO ACTION
...
ALTER TABLE md_class_attributes ADD CONSTRAINT md_class_attributes_clid_fk
FOREIGN KEY (class_id)
REFERENCES md_classes (class_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE md_class_relations ADD CONSTRAINT md_class_relations_frcl_fk
...
ALTER TABLE md_class_relations ADD CONSTRAINT md_class_relations_tocl_fk
...
ALTER TABLE cm_ci ADD CONSTRAINT cm_ci_clid_fk
FOREIGN KEY (class_id)
REFERENCES md_classes (class_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
...
ALTER TABLE dj_rfc_ci ADD CONSTRAINT dj_rfc_ci_clid_fk
FOREIGN KEY (class_id)
REFERENCES md_classes (class_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
...
ALTER TABLE md_class_actions ADD CONSTRAINT md_class_actions_cl_fk
FOREIGN KEY (class_id)
REFERENCES md_classes (class_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE dj_rfc_ci_attributes ADD CONSTRAINT dj_rfc_ci_attributes_ciid_fk
FOREIGN KEY (rfc_id)
REFERENCES dj_rfc_ci (rfc_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE dj_rfc_relation ADD CONSTRAINT dj_rfc_ci_dj_rfc_relation_fk
...
ALTER TABLE dj_rfc_relation ADD CONSTRAINT dj_rfc_ci_dj_rfc_relation_fk1
...
ALTER TABLE dj_ns_opt ADD CONSTRAINT dj_rfc_ci_dj_ns_opt_fk
FOREIGN KEY (rfc_id)
REFERENCES dj_rfc_ci (rfc_id)
ON DELETE CASCADE
ON UPDATE NO ACTION
...
ALTER TABLE dj_rfc_relation_attributes ADD CONSTRAINT rfc_relation_attributes_rfcrid_fk
FOREIGN KEY (rfc_id)
REFERENCES dj_rfc_relation (rfc_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE cm_ci_attributes ADD CONSTRAINT cm_ci_attributes_ciid_fk
FOREIGN KEY (ci_id)
REFERENCES cm_ci (ci_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE cm_ci_relations ADD CONSTRAINT cm_ci_relations_frid_fk
...
ALTER TABLE cm_ci_relations ADD CONSTRAINT cm_ci_relations_toid_fk
...
ALTER TABLE cm_ops_procedures ADD CONSTRAINT cm_ops_procedures_ci_fk
FOREIGN KEY (ci_id)
REFERENCES cm_ci (ci_id)
ON DELETE CASCADE
ON UPDATE NO ACTION
...
ALTER TABLE cm_ops_actions ADD CONSTRAINT cm_ops_actions_ci_fk
FOREIGN KEY (ci_id)
REFERENCES cm_ci (ci_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
...
ALTER TABLE cm_ns_opt ADD CONSTRAINT cm_ci_cm_ns_opt_fk
FOREIGN KEY (ci_id)
REFERENCES cm_ci (ci_id)
ON DELETE CASCADE
ON UPDATE NO ACTION
...
ALTER TABLE cm_ops_actions ADD CONSTRAINT cm_ops_actions_proc_fk
FOREIGN KEY (ops_proc_id)
REFERENCES cm_ops_procedures (ops_proc_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE cm_ci_relation_attributes ADD CONSTRAINT cm_ci_relation_attributes_crid_fk
FOREIGN KEY (ci_relation_id)
REFERENCES cm_ci_relations (ci_relation_id)
ON DELETE CASCADE
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE cm_ci_attributes ADD CONSTRAINT cm_ci_attributes_attr_fk
FOREIGN KEY (attribute_id)
REFERENCES md_class_attributes (attribute_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
NOT DEFERRABLE;

ALTER TABLE dj_rfc_ci_attributes ADD CONSTRAINT dj_rfc_ci_attributes_atrid_fk
FOREIGN KEY (attribute_id)
REFERENCES md_class_attributes (attribute_id)
ON DELETE RESTRICT
ON UPDATE RESTRICT
